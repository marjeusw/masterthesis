...
{
    public ChooseLableController label;
    public GameController gameController;
    private RectTransform rectTransform;
    private Animator animator;
    private float labelHeight = -1;

    //public GameObject colliderPush;
    //public GameObject colliderPat;
    ...
    public void SetupChoose(ChooseScene scene)
    {
        ...
        {
            ChooseLableController newLabel = Instantiate(label.gameObject, transform).GetComponent<ChooseLableController>();
        ...
        //size according to how many choices
